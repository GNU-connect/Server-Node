...
import { FETCH_CURRENT_USER_KEY } from 'src/api/public/users/presentation/decorators/fetch-current-user.decorator';
...
export class CurrentUserInterceptor implements NestInterceptor {
  ...
  async intercept(context: ExecutionContext, next: CallHandler) {
    const shouldFetch = this.reflector.getAllAndOverride<boolean>(FETCH_CURRENT_USER_KEY, [
      context.getHandler(),
      context.getClass(),
    ]);
